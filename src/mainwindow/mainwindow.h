...
private slots:
    ...
    static void help() {
        make_msg_box(
                "Введите предполагаемые x, y (определяются по графику) и необходимую точность, затем нажмите кнопку \"Решить\".\nДля управления масштабом графика кликните мышкой на нём и используйте клавиши \'+\' и \'-\'.\nДля перемещения \'←\' \'→\' \'↑\' \'↓\'");
    }
